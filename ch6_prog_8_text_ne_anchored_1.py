""" ch6 No.8  
Program name: text_ne_anchored_1.py 
Objective: Place different colored texts anchored south-west on a canvas. 

Keywords: canvas, text, color, font, anchor ne, top right. 
============================================================================79 
Comments: 
1. Text position orig_x, orig_y. 
2. anchor=NE. North-East.  
3. justify=LEFT. Default is LEFT.  
...
root = Tk() 
root.title('Text anchored NE (TOP RIGHT) with block widths of 800, 500 and 300 points/pixels.') 
...
orig_x = 850 
orig_y  = 50   
canvas_1.create_text(orig_x, orig_y,   anchor= NE, text=dasn,   fill='red', 
                                 width=800, font='SansSerif 10 ') 
canvas_1.create_oval(orig_x-16, orig_y-16,  orig_x+16, orig_y+16, outline='red', width =6) 
orig_y  = 180   
canvas_1.create_text(orig_x, orig_y,   anchor= NE, text=dasn,   fill='brown', 
                                 width=500, font='SansSerif 10 ') 
canvas_1.create_oval(orig_x-16, orig_y-16,  orig_x+16, orig_y+16, outline='red', width =6)  
orig_y  = 360    
canvas_1.create_text(orig_x, orig_y,   anchor= NE, text=dasn,   fill='blue', 
